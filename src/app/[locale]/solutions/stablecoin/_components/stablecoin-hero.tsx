    ...
    <section className="relative w-full min-h-[480px] sm:min-h-[540px] md:h-[560px] lg:h-[610px] overflow-hidden">
      <div className="absolute inset-0">
        <picture>
          ...
          <img src="/images/solution-bg1_640x.jpg" alt="Remi Network" width={1280} height={1960} loading="eager" decoding="async" className="w-full h-full object-cover"
      ...
      <div className="relative z-10 h-full flex pt-[140px] sm:pt-[160px] md:pt-[180px] lg:pt-[219px] pb-[48px]">
        <div className="max-w-[1536px] mx-auto px-[24px] sm:px-[48px] lg:px-[120px] w-full">
          <h1 className="inter-light text-white text-[32px] sm:text-[36px] md:text-[42px] lg:text-[48px] mb-[16px] sm:mb-[20px] md:mb-[24px]">
            Stablecoin Issuance
          </h1>
