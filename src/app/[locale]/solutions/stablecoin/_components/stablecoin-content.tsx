  ...
  return (
    <>
      ...
      <div className="bg-[#FAF8F7] px-[48px] lg:px-0">
        <div className="lg:max-w-[1024px] mx-auto py-[48px] lg:py-[64px] xl:py-[72px] 2xl:py-[88px]">
          <div className="mb-[48px] md:mb-[64px] lg:mb-[72px] xl:mb-[96px]">
            <h2 className="inter-medium text-[32px] text-[#29221D] text-left md:text-center mb-[12px]">
              Issuance Roadmap
            </h2>
          </div>
          <div className="mt-[48px] mx-auto">
            {roadmapPhases.map((p, i) => (
              ...
              >
                <div className="text-[#FF6900] inter-medium shrink-0">{p.phase}</div>
                <div className="flex-1">
                  <h3 className="mb-[15px] text-[16px] md:text-[18px] font-[500] inter-medium text-[#29221D]">
                    {p.title}
                  </h3>
                  <p className="inter-light text-[18px] text-[#86909C] leading-relaxed">
                    {p.description}
                  </p>
